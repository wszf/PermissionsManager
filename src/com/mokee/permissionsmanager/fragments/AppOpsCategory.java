...
public class AppOpsCategory extends ListFragment implements LoaderManager.LoaderCallbacks<List<AppOpEntry>>
	{
...
//				pa.startPreferencePanel(AppOpsDetails.class.getName(), args, R.string.app_ops_settings, null, this,
//						RESULT_APP_DETAILS);
				Intent intent=new Intent(getActivity(),AppOpsDetails.class);
